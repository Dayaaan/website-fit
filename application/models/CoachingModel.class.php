...
Class CoachingModel {
	...
	public function saveCoaching(array $coaching) {
		...
		$sql = "INSERT INTO coaching_form (lastname,firstname,age,email,gender,weight,height,nb_training,other,goal,created_at) VALUES (:lastname,:firstname,:age,:email,:gender,:weight,:height,:nb_training,:other,:goal,NOW())";
